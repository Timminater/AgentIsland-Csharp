...
public static class ReportPreview
{
    public static void Run(string output)
    {
        ...
        foreach (var nl in new[] { true, false })
        {
            L10n.Current = nl ? L10n.Language.Dutch : L10n.Language.English;
            var lang = nl ? "nl" : "en";
            ...
            var week = new WeeklyReportData(nl ? "13 aug – 19 aug" : "Aug 13 – Aug 19", 1_000_000_000, 250, providers,
                new long[] { 100_000_000, 200_000_000, 300_000_000, 100_000_000, 100_000_000, 100_000_000, 100_000_000 },
                nl ? new[] { "d", "v", "z", "z", "m", "d", "w" } : new[] { "T", "F", "S", "S", "M", "T", "W" },
            ...
            ReportCards.SavePng(ReportCards.Monthly(new MonthlyReportData(nl ? "augustus 2026" : "August 2026", 1_000_000_000, 250, providers, models)), Path.Combine(output, $"monthly-{lang}.png"), 1.5);
