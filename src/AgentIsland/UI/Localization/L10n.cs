...
public static partial class L10n
{
    ...
    private static readonly Dictionary<string, string> ChineseTable = new()
    {
        ...
        ["Others"] = "其他",
        ["All tokens (incl. cache)"] = "全部Token(含缓存)",
        ["≈ ${0} API value (partial estimate)"] = "≈ 相当于 ${0} 的 API 费用 (部分估算)",
        ["≈ ${0} estimated"] = "≈ ${0} 部分估算",
        ["No activity recorded"] = "暂无用量记录",
        ["No model activity"] = "暂无模型消耗记录",
        ["{0} other models ({1}%)"] = "其余 {0} 个模型 ({1}%)",
        ["1 other model ({0}%)"] = "其余 1 个模型 ({0}%)",
        ["Past {0} weeks"] = "过去 {0} 周",
        ["{0}-day streak 🔥"] = "连续 {0} 天 🔥",
        ...
        ["Not detected — create a DeepSeek Harness session"] = "未检测到 — 请先创建 DeepSeek Harness 会话",
        ["DeepSeek Harness token ledger"] = "DeepSeek Harness Token 记录",
        ["API balance"] = "API 余额",
        ["available"] = "可用",
        ["unavailable"] = "不可用",
        ["No balance details"] = "没有余额明细",
        ["granted {0} · topped up {1}"] = "赠送 {0} · 充值 {1}",
        ["balance {0}"] = "余额 {0}",
        ...
        ["Windows native edition · Independent implementation"] = "Windows 原生独立实现版",
        ["This Repo (GitHub)"] = "本项目 GitHub 地址",
        ["Upstream Repo"] = "Fork 原项目地址",
        ["Inspiration (Codex)"] = "参考项目",
